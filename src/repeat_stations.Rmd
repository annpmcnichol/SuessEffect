...
# how do we tell if elements of nn are from the same cruise as their row?
glodap_stations[1,]$cruise #cruise of the row
glodap_stations[nearest_stations$nn[[1]],]$cruise #cruises of the elements

# for element in row, drop element if element cruise == row cruise

# returns vector where TRUE should be dropped
glodap_stations[1,]$cruise == glodap_stations[nearest_stations$nn[[1]],]$cruise

# Well, that works, but we've lost our But wait, we can just flatten this list and keep all the rows of glodap_stations for our plot!
